...
class Bookings {
  ...
  async loadAdditionalInfo() {
    ...
    const hotelIds = [
      ...new Set(rooms.filter((r) => r && r.hotel_id).map((r) => r.hotel_id)),
    ];
  ...
  renderMyBookings() {
                ...
                <div class="alert alert-info">
                    ...
                    ${
                      this.bookings.length === 0
                        ...
                        : "Бронирования не найдены по заданным фильтрам"
                    }
                </div>
            `;
      return;
    ...
    const html = this.filteredBookings
                            ...
                            <div class="row g-2 mt-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="card-text mb-1">
                                        ...
                                        <strong>Стоимость:</strong> ${parseFloat(
    ...
    const modalHtml = `
            <div class="modal fade" id="bookingDetailsModal" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Детали бронирования #${
                              booking.booking_id
                            }</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p><i class="bi bi-people me-2"></i>Гостей: <strong>${
                                      booking.number_of_guests || 1
                                    }</strong></p>
                                </div>
                                <div class="col-md-6">
                                    <p><i class="bi bi-cash me-2"></i>Стоимость: <strong>${
                                      booking.total_price || 0
                                    } ₽</strong></p>
                                    <p>Статус: <span class="badge ${
                                      statusBadge.class
                                    }">${statusBadge.text}</span></p>
                                </div>
                            </div>
                            ${
